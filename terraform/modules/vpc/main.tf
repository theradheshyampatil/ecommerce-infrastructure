...
# ============================================
# Creates: VPC, Subnets, Internet Gateway, NAT, Route Tables
...
# Private Subnets - For EKS nodes, RDS database
...
# Only 1 NAT Gateway to save costs (use NAT instance for even cheaper)
